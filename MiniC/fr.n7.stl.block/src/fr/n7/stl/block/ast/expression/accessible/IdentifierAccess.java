...
//							this.expression = new FieldDeclaration((FieldDeclaration) _declaration);
//							return true;
//						} else {
							Logger.error("The declaration for " + this.name + " is of the wrong kind: "+_declaration.getType()+" in "+this.toString());
							return false;
//						}
					}
				}
	...
	public Fragment getCode(TAMFactory _factory) {
		Fragment identFrag = _factory.createFragment();
		identFrag.add((TAMInstruction) this.expression.getCode(_factory));
		return identFrag;
	}
