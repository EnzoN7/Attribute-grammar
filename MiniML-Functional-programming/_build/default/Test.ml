...
let%test _ = ( (miniML "../../exemples/exemple-10.mml") = (BooleanValue false) )
let%test _ = ( (miniML "../../exemples/exemple-14.mml") = (BooleanValue true) )
...
let%test _ = ( (miniML "../../exemples/exemple-18.mml") = ErrorValue TypeMismatchError )
let%test _ = ( (miniML "../../exemples/exemple-19.mml") = ErrorValue (UnknownIdentError ("y")) )
let%test _ = ( (miniML "../../exemples/exemple-20.mml") = ErrorValue RuntimeError )